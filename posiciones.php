			...
			<table id="posiciones">
				...
				<tbody>
				  <tr>
				    ...
				    <td>
				    	<a href="https://www.toyota.com/racing" target="_blank"><img src="img/posiciones/toyotaLogo2.png" class="logo toyota"></a>
				    </td>
				    <td>3095</td>
				    <td>0</td>
				    <td>6</td>
				  ...
				  <tr>
				    ...
				    <td><a href="https://performance.ford.com/" target="_blank"><img src="img/posiciones/fordLogo.png" class="logo ford"></a></td>
				    <td>3074</td>
				    <td>-21</td>
				    <td>3</td>
				    <td>12</td>
				  ...
				  <tr>
				    ...
				    <td>
				    	...
				    	<img src="img/posiciones/chevroletLogoSmol.png" class="logo chevrolet">
				    </td>
				    <td>3063</td>
				    <td>-32</td>
				    <td>1</td>
				  ...
				  <tr>
				    ...
				    <td>
				    	<a href="https://www.chevrolet.com/motorsports" target="_blank">
				    	<img src="img/posiciones/chevroletLogoSmol.png" class="logo chevrolet"></a>
				    </td>
				    <td>3025</td>
				    <td>-70</td>
				    <td>3</td>
				  ...
				  <tr>
				   <td>18</td>
				    ...
				    <td><a href="https://performance.ford.com/" target="_blank"><img src="img/posiciones/fordLogo.png" class="logo ford"></td>
				    <td>730</td>
				    <td>-2365</td>
				    <td>0</td>
				    <td>3</td>
